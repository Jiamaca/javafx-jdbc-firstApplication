...
//			controller.suscribeDataChangeListener(this);
...
//		}
	...
	private void initEditButtons() {
		...
		tableColumnEDIT.setCellFactory(param -> new TableCell<Seller, Seller>() {
			...
			@Override
			protected void updateItem(Seller dep, boolean empty) {
				...
				setGraphic(button);
				button.setOnAction(
						event -> createDialogForm(dep, "/gui/SellerForm.fxml", Utils.currentStage(event)));
			}
		});
	}
	...
	private void removeEntity(Seller obj) {
		...
		if (result.get() == ButtonType.OK) {
			if (service == null) {
				throw new IllegalStateException("Sevice null");
			}
			try {
				service.remove(obj);
				updateTableView();
